...
function ProductDetailsPresenter() {
    ...
    const [showDeleteProductMessage, setShowDeleteProductMessage] = useState(false);
    ...
    async function deleteReview(customerId, reviewId) {
        console.log('first')
        // await axios.delete('', { data: { customerId, reviewId, productId } })
        //     .then((res) => {
        ...
        <main className='productDetailMain'>
            <div className="productDetailDivForImgAndData ">
                ...
                <div className="productDetailData">
                    ...
                    <div className="productDetailsDataFooter">
                        ...
                        <button
                            onClick={() => setShowDeleteProductMessage(true)}
                        >
            ...
            >
                ...
                <DialogActions>
                    ...
                    <Button
                        onClick={handleAgreeDeleteProductMessage}
                    >
                        AGREE
                    </Button>
                </DialogActions>
